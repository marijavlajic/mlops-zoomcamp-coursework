...
@task(log_prints=True, name='Train')
...
def main_flow_q5(
    ...
    # MLflow settings
        ...
        # Load 
        # !!! Intentional bug to make it send the fail email !!!
        df_train = read_date(train_path)
...
# example_email_send_message_flow(["mvlajic@gmail.com"])